...
initAppverseKeyboardEvents = function(){    
    if (document.createEvent) {
      Appverse.keyboardhide = document.createEvent("HTMLEvents");
      Appverse.keyboardhide.initEvent("native.keyboardhide", true, true);
    } else {
      Appverse.keyboardhide = document.createEventObject();
      Appverse.keyboardhide.eventType = "native.keyboardhide";
    }
    
    Appverse.keyboardhide.eventName = "native.keyboardhide";
    
    
    if (document.createEvent) {
      Appverse.keyboardshow = document.createEvent("HTMLEvents");
      Appverse.keyboardshow.initEvent("native.keyboardshow", true, true);
    } else {
      Appverse.keyboardshow = document.createEventObject();
      Appverse.keyboardshow.eventType = "native.keyboardshow";
    }
    Appverse.keyboardshow.eventName = "native.keyboardshow";
};
...
Appverse = {
    ...
    /**
    * <font style="color:orange">[JS event - not an Appverse listener]</font> - Applications could subscribe to 'native.keyboardhide' event to be aware of software keyboard dismiss. Not available for Android devices under 4.4
    * @aside guide application_listeners
    * <br> @version 5.1.5
    * @event
    * <pre> Available in: <br> iOS <img src="resources/images/check.png"/> | android <img src="resources/images/check.png"/> &gt;= 4.4 | windows <img src="resources/images/check.png"/> | emulator <img src="resources/images/error.png"/></pre>
    */
    keyboardhide:{},// The custom event that will be created
    
    /**
    * <font style="color:orange">[JS event - not an Appverse listener]</font> - Applications could subscribe to 'native.keyboardshow' event to be aware of software keyboard appear. Not available for Android devices under 4.4
    * @aside guide application_listeners
    * <br> @version 5.1.5
    * @event 
    * <pre> Available in: <br> iOS <img src="resources/images/check.png"/> | android <img src="resources/images/check.png"/> &gt;= 4.4 | windows <img src="resources/images/check.png"/> | emulator <img src="resources/images/error.png"/></pre>
    */
    keyboardshow:{}, // The custom event that will be created
    ...
    checkAppverseContextData: function () {
        ...
        try {
			console.log("polling for appverse context...");
...
/**
 * Show the device software keyboard
 * <br> @version 5.1.5
 * @method
 * <pre> Available in: <br> iOS <img src="resources/images/error.png"/> | android <img src="resources/images/check.png"/> | windows <img src="resources/images/check.png"/> | emulator <img src="resources/images/error.png"/> </pre>
 */
System.prototype.KeyboardShow = function()
{
    post_to_url_async(Appverse.System.serviceName, "KeyboardShow", null, null, null);
};
 ...
 * <br> @version 5.1.5
 * @method
 * <pre> Available in: <br> iOS <img src="resources/images/check.png"/> | android <img src="resources/images/check.png"/> | windows <img src="resources/images/check.png"/> | emulator <img src="resources/images/error.png"/> </pre>
 */
System.prototype.KeyboardHide = function()
{
    post_to_url_async(Appverse.System.serviceName, "KeyboardHide", null, null, null);
};

/**
 * Disable the automatic scrool on input focus
 * <br> @version 5.1.5
 * @param {bool} disable whether the disable is active or not
 * @method
 * <pre> Available in: <br> iOS <img src="resources/images/check.png"/> | android <img src="resources/images/check.png"/> | windows <img src="resources/images/check.png"/> | emulator <img src="resources/images/error.png"/> </pre>
 */
System.prototype.KeyboardDisableScroll = function(disable)
{
    post_to_url_async(Appverse.System.serviceName, "KeyboardDisableScroll", get_params([disable]), null, null);
};

/**
 * Provides the number of screens connected to the device. Display 1 is the primary.
 * <br> @version 5.1.5
 * @param {bool} hide whether it should be hidden or not
 * @method
 ...
 */
System.prototype.KeyboardHideAccessoryBar = function(hide)
{
    post_to_url_async(Appverse.System.serviceName, "KeyboardHideAccessoryBar", get_params([hide]), null, null);
};
...
/**
 * @class Appverse.USPG
 * Module class to access Appverse USPG module interface.
 * <br>This interface provides features to secure connection with UniCredit Secure Payments Gateway.<br>
 * <br> @version 5.0.12
 * @component
 * @aside guide appverse_modules
 * @constructor Constructs a new USPG interface.
 * @return {Appverse.USPG} A new USPG interface.
 */
USPG = function () {
    /**
     * @cfg {String}
     * USPG service name (as configured on Platform Service Locator).
     * <br> @version 5.0.12
     */
    this.serviceName = "uspg";


    /**
     * Default value for a success operation
     * <br> @version 5.0.12
     * @type int
     */
    this.USPG_RC_OK = 0;
    ...
    /**
     * @event onPayment Fired when a payment verification happens
     * <br> For further information see, {@link Appverse.USPG.Response response}.
     * <br> Method to be overrided by JS applications, to handle this event.
     * @aside guide application_listeners
     * <br> @version 5.0.12
     * @event
     * @param {Appverse.USPG.Response} response with result from the operation;
     * <pre> Available in: <br> iOS <img src="resources/images/warning.png"/> *mock data | android <img src="resources/images/check.png"/> | windows <img src="resources/images/error.png"/> | emulator <img src="resources/images/check.png"/> *mock data</pre>
     *
     */
    this.onPayment = function (response) {
        console.log(arguments);
        console.log('%c Override onPayment method! ', 'background: #222; color: #bada55');
    };

    /**
     * @event onActivate Fired when the library activate
     * <br> For further information see, {@link Appverse.USPG.Response response}.
     * <br> Method to be overrided by JS applications, to handle this event.
     * @aside guide application_listeners
     * <br> @version 5.0.12
     ...
     *
     */
    this.onActivate = function (response) {
        console.log(arguments);
        console.log('%c Override onActivate method! ', 'background: #222; color: #bada55');
    };

    /**
     * @event onLogin Fired when the login is performed
     * <br> For further information see, {@link Appverse.USPG.Response response}.
     * <br> Method to be overrided by JS applications, to handle this event.
     * @aside guide application_listeners
     * <br> @version 5.0.12
    ...
    this.onLogin = function (response) {
        console.log(arguments);
        console.log('%c Override onLogin method! ', 'background: #222; color: #bada55');
    };

    /**
     * @event onCheckStatus Fired when check status is performed
     * <br> For further information see, {@link Appverse.USPG.Response response}.
     * <br> Method to be overrided by JS applications, to handle this event.
     * @aside guide application_listeners
     * <br> @version 5.0.12
     ...
     *
     */
    this.onCheckStatus = function (response) {
        console.log(arguments);
        console.log('%c Override onCheckStatus method! ', 'background: #222; color: #bada55');
    };

};

Appverse.USPG = new USPG();


/**
 * Activate USPG Library
 * <br> @version 5.0.12
 * @param {Appverse.USPG.ID} id used to identify this instance of the app
 * @param {String} password in SHA256 codification
 * @method
 * <pre> Available in: <br> iOS <img src="resources/images/warning.png"/> *mock data | android <img src="resources/images/check.png"/> | windows <img src="resources/images/error.png"/> | emulator <img src="resources/images/check.png"/> *mock data</pre>
 */
USPG.prototype.Activate = function (id, password) {
    post_to_url_async(Appverse.USPG.serviceName, "Activate", get_params([id, password]), null, null);
};

/**
 * Silent Login for USPG Library
 * <br> @version 5.0.12
 * @param {String} password in SHA256 codification
 * @method
 * <pre> Available in: <br> iOS <img src="resources/images/warning.png"/> *mock data | android <img src="resources/images/check.png"/> | windows <img src="resources/images/error.png"/> | emulator <img src="resources/images/check.png"/> *mock data</pre>
 */
USPG.prototype.Login = function (password) {
    post_to_url_async(Appverse.USPG.serviceName, "Login", get_params([password]), null, null);
};

/**
 * Check activation state of the library for given user
 * <br> @version 5.0.12
 * @param {Appverse.USPG.ID} id used to identify this instance of the app
 * @param {String} callbackFunctionName The name of the callback function to be called when the method response is handled. Arguments of this function are the invocation result object and the invocation callbackId. Defaults to "callback".
 * @param {String} callbackId The id to uniquely identify different callbacks with the same callback function. Defaults to "callbackid".
 ...
 * <pre> Available in: <br> iOS <img src="resources/images/warning.png"/> *mock data | android <img src="resources/images/check.png"/> | windows <img src="resources/images/error.png"/> | emulator <img src="resources/images/check.png"/> *mock data</pre>
 */
USPG.prototype.CheckState = function (id, callbackFunctionName, callbackId) {
    post_to_url_async(Appverse.USPG.serviceName, "CheckState", get_params([id]), callbackFunctionName, callbackId);
};

/**
 * Check activation state of the library for given user
 * <br> @version 5.0.12
 * @param {Appverse.USPG.Payment} payment info
 * @param {String} callbackFunctionName The name of the callback function to be called when the method response is handled. Arguments of this function are the invocation result object and the invocation callbackId. Defaults to "callback".
 * @param {String} callbackId The id to uniquely identify different callbacks with the same callback function. Defaults to "callbackid".
 * @method
 * <pre> Available in: <br> iOS <img src="resources/images/warning.png"/> *mock data | android <img src="resources/images/check.png"/> | windows <img src="resources/images/error.png"/> | emulator <img src="resources/images/check.png"/> *mock data</pre>
 */
USPG.prototype.CheckStatus = function (payment) {
    post_to_url_async(Appverse.USPG.serviceName, "CheckStatus", get_params([payment]), null, null);
};
 ...
 * <pre> Available in: <br> iOS <img src="resources/images/warning.png"/> *mock data | android <img src="resources/images/check.png"/> | windows <img src="resources/images/error.png"/> | emulator <img src="resources/images/check.png"/> *mock data</pre>
 */
USPG.prototype.PaymentAuth = function (payment) {
    post_to_url_async(Appverse.USPG.serviceName, "PaymentAuth", get_params([payment]), null, null);
};
